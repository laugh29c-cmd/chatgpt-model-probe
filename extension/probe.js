...
function requestedModel(body, depth = 0) {
...
function surfaceFor(page, endpoint, body) {
...
function extractEvidence(o, acc = {}, depth = 0) {
...
function inspectShape(o, diag, path = '', depth = 0) {
